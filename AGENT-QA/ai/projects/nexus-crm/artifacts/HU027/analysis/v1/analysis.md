...
| HU | HU027 |
| Work Item Azure | 496 |
| Titulo | HU027 - Configurar preferencias funcionales |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:07.956171+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 496. | Trazabilidad externa confirmada. |
