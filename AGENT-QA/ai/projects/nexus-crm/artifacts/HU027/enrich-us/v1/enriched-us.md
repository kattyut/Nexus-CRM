# HU enriquecida - HU027: Configurar preferencias funcionales
...
| Contexto breve | Configurar preferencias funcionales. |
| Prioridad | 2 |
| Version | v1 |
...
| HU ID | HU027 |
| Work Item Azure DevOps | 496 |
| Titulo origen | HU027 - Configurar preferencias funcionales |
...
Como usuario  
Quiero definir comportamientos predeterminados para empresas, contactos y dashboard  
Para empresas, contactos y dashboard
...
La HU HU027 pertenece al backlog funcional de Nexus CRM y cubre la capacidad 'Configurar preferencias funcionales'. La version enriquecida conserva la intencion original leida desde Azure DevOps y agrega criterios verificables para refinamiento, QA y validacion de negocio.
...
Cuando solicita configurar preferencias funcionales  
...
Cuando completa la informacion requerida para configurar preferencias funcionales  
Entonces el sistema procesa la operacion  
Y confirma el resultado de forma clara.

### CA-003 - Validar informacion obligatoria

Dado que el usuario esta ejecutando configurar preferencias funcionales  
...
Dado que un usuario no autorizado intenta configurar preferencias funcionales  
...
Dado que la operacion configurar preferencias funcionales se completa correctamente  
...
### CA-006 - Validar alcance: Empresas inactivas

Dado que el alcance de la HU incluye empresas inactivas  
Cuando el usuario ejecuta el flujo correspondiente  
Entonces el sistema permite validar empresas inactivas segun las reglas aprobadas por negocio.

### CA-007 - Validar alcance: Empresas recientes

Dado que el alcance de la HU incluye empresas recientes  
Cuando el usuario ejecuta el flujo correspondiente  
Entonces el sistema permite validar empresas recientes segun las reglas aprobadas por negocio.

### CA-008 - Validar alcance: Contactos recientes

Dado que el alcance de la HU incluye contactos recientes  
Cuando el usuario ejecuta el flujo correspondiente  
Entonces el sistema permite validar contactos recientes segun las reglas aprobadas por negocio.

### CA-009 - Validar alcance: Contactos saturados
...
- La HU fue leida desde Azure DevOps como Work Item 496.
- El titulo funcional es HU027 - Configurar preferencias funcionales.
- El estado actual en Azure DevOps es New.
- La HU debe mantener trazabilidad con el proyecto Nexus.
- El alcance indicado incluye Empresas inactivas.
- El alcance indicado incluye Empresas recientes.
- El alcance indicado incluye Contactos recientes.
- El alcance indicado incluye Contactos saturados.
- El alcance indicado incluye Widgets dashboard.
