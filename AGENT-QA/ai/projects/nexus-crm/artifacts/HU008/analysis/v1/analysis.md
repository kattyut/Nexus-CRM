...
| HU | HU008 |
| Work Item Azure | 460 |
| Titulo | HU008 - Administrar contactos |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:55.171448+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 460. | Trazabilidad externa confirmada. |
