...
| HU | HU018 |
| Work Item Azure | 477 |
| Titulo | HU018 - Consultar detalle de coincidencias |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:02.537932+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 477. | Trazabilidad externa confirmada. |
