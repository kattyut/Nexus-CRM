...
| HU | HU022 |
| Work Item Azure | 488 |
| Titulo | HU022 - Consultar indicadores estratégicos |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:05.203021+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 488. | Trazabilidad externa confirmada. |
