...
| HU | HU007 |
| Work Item Azure | 456 |
| Titulo | HU007 - Consultar empresas |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:54.037209+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 456. | Trazabilidad externa confirmada. |
