...
| HU | HU012 |
| Work Item Azure | 469 |
| Titulo | HU012 - Programar seguimiento comercial |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:57.903102+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 469. | Trazabilidad externa confirmada. |
