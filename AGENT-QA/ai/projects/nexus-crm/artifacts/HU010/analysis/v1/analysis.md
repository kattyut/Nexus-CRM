...
| HU | HU010 |
| Work Item Azure | 465 |
| Titulo | HU010 - Administrar actividades comerciales |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:56.312203+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 465. | Trazabilidad externa confirmada. |
