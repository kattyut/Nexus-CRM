...
| HU | HU014 |
| Work Item Azure | 472 |
| Titulo | HU014 - Revisar inconsistencias de importación |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:59.712585+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 472. | Trazabilidad externa confirmada. |
