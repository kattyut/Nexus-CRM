...
| HU | HU025 |
| Work Item Azure | 492 |
| Titulo | HU025 - Gestionar alertas |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:06.816159+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 492. | Trazabilidad externa confirmada. |
