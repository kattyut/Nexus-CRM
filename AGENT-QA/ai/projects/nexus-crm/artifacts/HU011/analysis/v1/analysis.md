...
| HU | HU011 |
| Work Item Azure | 467 |
| Titulo | HU011 - Consultar historial comercial |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:57.278553+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 467. | Trazabilidad externa confirmada. |
