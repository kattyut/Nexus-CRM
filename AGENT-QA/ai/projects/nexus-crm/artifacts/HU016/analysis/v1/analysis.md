...
| HU | HU016 |
| Work Item Azure | 475 |
| Titulo | HU016 - Consultar posibles registros duplicados |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:01.141030+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 475. | Trazabilidad externa confirmada. |
