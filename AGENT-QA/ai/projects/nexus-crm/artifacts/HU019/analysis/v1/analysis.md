...
| HU | HU019 |
| Work Item Azure | 479 |
| Titulo | HU019 - Consultar indicadores generales del CRM |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:03.144955+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 479. | Trazabilidad externa confirmada. |
