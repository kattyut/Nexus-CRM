...
| HU | HU028 |
| Work Item Azure | 498 |
| Titulo | HU028 - Configurar notificaciones |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:08.847350+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 498. | Trazabilidad externa confirmada. |
