...
- Name: openapi-crud.spec.ts >> Nexus API - CRUD desde OpenAPI Swagger >> SWG-CRUD-010 | Activities - crear, actualizar y eliminar con contacto y tipo
- Location: tests\openapi-crud.spec.ts:259:7
...
Expected value: 400
Received array: [200, 201, 202, 204]
```
