...
- Name: openapi-contract.spec.ts >> Nexus API - contrato desde OpenAPI Swagger >> SWG-CT-011 | GET /activities responde segun contrato (Nexus.Api)
- Location: tests\openapi-contract.spec.ts:61:9
