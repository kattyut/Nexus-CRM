...
| HU | HU006 |
| Work Item Azure | 452 |
| Titulo | HU006 - Administrar empresas |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:52.825298+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 452. | Trazabilidad externa confirmada. |
