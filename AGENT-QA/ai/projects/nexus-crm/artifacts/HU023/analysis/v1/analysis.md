...
| HU | HU023 |
| Work Item Azure | 489 |
| Titulo | HU023 - Consultar análisis y distribución de datos |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:34:05.774623+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 489. | Trazabilidad externa confirmada. |
