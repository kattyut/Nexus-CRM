...
| HU | HU004 |
| Work Item Azure | 446 |
| Titulo | HU004 - Administrar roles |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:51.012360+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 446. | Trazabilidad externa confirmada. |
