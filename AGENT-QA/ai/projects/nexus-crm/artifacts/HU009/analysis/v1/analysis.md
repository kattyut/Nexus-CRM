...
| HU | HU009 |
| Work Item Azure | 462 |
| Titulo | HU009 - Asociar contactos a empresas |
| Provider | Azure DevOps |
| Source | Azure DevOps |
| Version fuente | source/v1 |
| Version analisis | v1 |
| Fecha de analisis | 2026-06-02T21:33:55.766216+00:00 |
...
| Trazabilidad | Buena | Work Item real validado en Azure DevOps, ID 462. | Trazabilidad externa confirmada. |
